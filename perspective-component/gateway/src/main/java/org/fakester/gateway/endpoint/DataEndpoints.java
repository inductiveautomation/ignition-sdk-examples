...
public final class DataEndpoints {
    ...
    private static final AtomicReference<Long> tagCount = new AtomicReference<>(0L);
    private static final AtomicReference<Long> timestampOfLastCount = new AtomicReference<>(0L);
    ...
    public static void mountRoutes(RouteGroup routes) {
        // creates a new data route reachable at host:port/main/data/radcomponents/component/tagcount
     ...
     * </pre>
     *
     * <p>Tag counts are cached and re-calculated no more often than {@link DataEndpoints#CACHE_DURATION_MS}.</p>
     *
