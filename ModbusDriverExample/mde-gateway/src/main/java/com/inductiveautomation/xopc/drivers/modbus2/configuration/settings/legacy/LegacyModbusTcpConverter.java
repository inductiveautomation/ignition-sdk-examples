...
public class LegacyModbusTcpConverter extends LegacyDeviceConfigConverter<ModbusTcpDriverSettings> {

	public LegacyModbusTcpConverter(GatewayContext context) {
		super(context);
	}

	@Override
	public String getDriverClassName() {
		return "com.inductiveautomation.xopc.drivers.modbus2.ModbusDriver2";
	}

	@Override
	protected String getDriverTypeId() {
		return ModbusTcpDriverType.TYPE_ID;
	}
