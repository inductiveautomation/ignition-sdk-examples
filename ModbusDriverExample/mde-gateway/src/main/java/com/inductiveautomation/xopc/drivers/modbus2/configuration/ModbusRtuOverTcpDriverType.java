...
import com.inductiveautomation.xopc.drivers.modbus2.ModbusOverTCPDriver;
...
public class ModbusRtuOverTcpDriverType extends DriverType {

	public static final String TYPE_ID = "ModbusRtuOverTcp";

	public ModbusRtuOverTcpDriverType() {
		super(TYPE_ID, "Modbus." + "ModbusRtuOverTcpDriverType.Name", "Modbus." + "ModbusRtuOverTcpDriverType.Description");
	}
	...
	public Driver createDriver(DriverContext driverContext, DeviceSettingsRecord deviceSettings) {
		...
		return new ModbusOverTCPDriver(driverContext, settings);
	}
