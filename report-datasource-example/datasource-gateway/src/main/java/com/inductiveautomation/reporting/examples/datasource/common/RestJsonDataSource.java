package com.inductiveautomation.reporting.examples.datasource.common;
...
import com.inductiveautomation.reporting.examples.datasource.utils.JsonUtils;
 ...
 * and registering it in the {@link com.inductiveautomation.reporting.examples.datasource.gateway.GatewayHook#startup(LicenseState)}
...
public class RestJsonDataSource implements ReportDataSource {
     ...
     */
    @Override
    public void gatherData(ReportExecutionContext reportExecutionContext, Serializable _configObject) throws Exception {
